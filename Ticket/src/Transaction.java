...
public class Transaction {
	Transaction(int amt,String un,String s1,String dat1,String Mov1,String Tim1){
		JFrame tr=new JFrame("Transaction");
		JLabel no = new JLabel("Total Number of seats:"+amt/150+"");
			  ...
			  public void actionPerformed(ActionEvent e){  
				  ...
				  Fillo filloc= new Fillo();
					...
					try {
						...
						String str1Queryc ="SELECT * FROM Sheet3 WHERE EXISTS (SELECT BankId FROM Sheet1 WHERE TransactionId='"+tf1.getText()+"' and BankId='"+un+"')";
	                    ...
	                    while(rsc.next()) {
	                    	if(rsc.getField("TransactionId").equals(un1)&&(Integer.parseInt(rsc.getField("Balance"))>amt)) {
	                    		...
	                    		String strup="Update Sheet3 Set Balance='"+amt1+"' where BankId='"+un+"' ";
...
public static void main(String args[]) {
    ...
    String sam2="";
    String sam3="";
	new Transaction(a,s,s1,sam1,sam2,sam3);
}
}
